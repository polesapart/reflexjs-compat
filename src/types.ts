/* eslint-disable @typescript-eslint/no-shadow,@typescript-eslint/ban-types */
// noinspection JSUnusedGlobalSymbols,JSUnresolvedReference
// noinspection JSUnusedGlobalSymbols

import type React from 'react'
import { type Property, type Pseudos, type StandardLonghandProperties, type StandardShorthandProperties } from 'csstype'
import { type ColorModesScale, type Scale, type ThemeStyles, type ThemeUICSSProperties, type TLengthStyledSystem } from '@theme-ui/core'
...
export type SxProps = Omit<StyleProps, 'sx'> | {
  [key: string]: SxProps
} | {
  [K in Pseudos | keyof React.JSX.IntrinsicElements]: SxProps;
}
...
export type ComponentWithStyleProps<T extends React.ElementType> = Assign<React.ComponentPropsWithRef<T>, StyleProps>
